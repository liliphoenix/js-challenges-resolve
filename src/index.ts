...
import { transformToArr } from './js/stringToArr'
import { arrConcat } from './js/arrToPeace'
import { andOrExclude } from './js/andOrExcludeArr'
import { permute } from './js/permute'
import { isCycleObject } from './js/isCycleObject'
